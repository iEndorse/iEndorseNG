...
const SubSummaryModal: React.FC<SubSummaryModalProps> = ({ isOpen, onClose,onSubmit, details, Loading }) => {
          ...
          <div className="p-4 md:p-5">
            ...
            <div className="flex-col max-w-sm space-y-2 justify-center mt-8 mb-28">
               <div className='border-b    pb-2 flex justify-between'>
                   ...
                   <span className='font-medium' > {details?.subscriptionPlan} </span>
               </div>

               <div className='border-b    pb-2 flex justify-between'>
                   <span className=''> Amount Payable</span>
                   <span className='font-medium' > {details?.amount} Naira</span>
               </div>
            ...
            >
            <span>{Loading ? "" : "Proceed to Pay " }  </span>
            {Loading && (
                  <LineWave
                    visible={true}
                    height="40"
...
export default SubSummaryModal;